...
termsandcondition.grid(row=9,column=0,pady=18,padx=15)
...
alreadyaccount=Button(frame,text="Don't have an account?",font=('Open Sans',9,'bold'),bg='white',
                    fg='firebrick1')
