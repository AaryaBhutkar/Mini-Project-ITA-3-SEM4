...
root.background_image = ImageTk.PhotoImage(Image.open("/Users/aaryabhutkar/Downloads/mini project/financial-figures-graph-red-4375601.png"))
...
def save_income():
    ...
    conn = sqlite3.connect('income_database.db')
    ...
    if income.isnumeric():
        cursor.execute("INSERT INTO income(income) VALUES (?)", (float(income),))
        conn.commit()
...
add_button = tk.Button(padx=5, pady=5, text='Done', font=('Bold', 12), bg="aqua", fg="black", command=save_income)
